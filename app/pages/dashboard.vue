  ...
  <div>
    ...
    <div class="p-6">
      ...
      <UiEmptyState
        ...
        description="Create your first organization to get started with project management."
      ...
      <div v-else-if="orgStore.currentOrganization" class="space-y-6">
        <div class="grid gap-6 md:grid-cols-3">
          ...
          <UiStatCard
            label="Organization"
            :value="orgStore.currentOrganization.name"
            color="primary"
          >
            <template #icon>
          ...
          <UiStatCard
            label="Members"
            :value="orgStore.currentOrganization.memberCount"
            color="green"
          >
            <template #icon>
              <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <UiStatCard
            label="Your Role"
            :value="orgStore.currentOrganization.myRole"
            color="blue"
          >
            <template #icon>
              <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
