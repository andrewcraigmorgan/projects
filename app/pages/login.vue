    ...
    <div class="max-w-md w-full space-y-8">
      <div class="text-center">
        ...
        <p class="mt-2 text-sm text-gray-500 dark:text-gray-500">
          Or
          <NuxtLink to="/register" class="text-primary-600 hover:text-primary-500 dark:text-primary-400 font-medium">
      ...
      <form class="mt-8 space-y-6 bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-soft-lg border border-gray-200/60 dark:border-gray-700/60" @submit.prevent="handleSubmit">
        ...
        <div class="flex items-center justify-between">
          ...
          <NuxtLink to="/forgot-password" class="text-sm text-primary-600 hover:text-primary-500 dark:text-primary-400 font-medium">
            Forgot password?
          </NuxtLink>
        </div>
        ...
        <div class="text-center">
          <NuxtLink to="/magic-link" class="text-sm text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
